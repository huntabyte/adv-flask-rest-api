...
USER_CONFIRMED = "Successfully confirmed user."
FAILED_TO_CREATE = "Internal server error. Failed to create user."
SUCCESS_REGISTER_MESSAGE = "Account created successfully. An email with an activation link has been sent to your email address."
